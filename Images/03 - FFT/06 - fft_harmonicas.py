...
# funcao f(t) que descreve o sinal
...
# intervalo de frequencias - largura de banda da analise = 2B
# frequencia max B = quant harmonicas x resolucao de freq
#
B = M*w0
print 'maxima frequencia representavel B = ',B
...
# grafico do espectro de amplitudes (modulo de F(w) = absolute(Fs))
subplot(212)
grid(True)
